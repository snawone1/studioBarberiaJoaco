...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ addProduct(data) {
    ...
    await new Promise((resolve)=>setTimeout(resolve, 1000));
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/products'); // Revalidate the products page
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/admin'); // Revalidate the admin page (if it displays product list directly)
    return {
        success: true,
        message: 'Producto añadido con éxito (Simulado).',
        product: newProduct
    };
}
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ deleteProduct(productId) {
    ...
    await new Promise((resolve)=>setTimeout(resolve, 1000));
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/products'); // Revalidate the products page
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/admin'); // Revalidate the admin page
    return {
        success: true,
        message: 'Producto eliminado con éxito (Simulado).'
    };
}
;
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$validate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ensureServerEntryExports"])([
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ea7c3edc._.js.map