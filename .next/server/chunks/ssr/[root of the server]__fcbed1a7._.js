...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ submitSiteSettings(data) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/admin/settings'); // Revalidate the new settings page
    return {
        success: true,
        message: 'Configuración del sitio procesada. Los cambios se reflejarán en breve (puede requerir refrescar la página).'
    };
}
