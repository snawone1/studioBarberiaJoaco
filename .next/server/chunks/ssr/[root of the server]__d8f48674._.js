...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ getSiteDetails() {
    try {
        const siteDetailsDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["doc"])(appSettingsCollectionRef, 'siteDetails');
        const docSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDoc"])(siteDetailsDocRef);
        if (docSnap.exists()) {
            const data = docSnap.data();
            return {
                name: data.siteName || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$site$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["siteConfig"].name,
                description: data.siteDescription || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$site$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["siteConfig"].description
            };
        }
        return {
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ submitSiteSettings(data) {
    try {
        const siteDetailsDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["doc"])(appSettingsCollectionRef, 'siteDetails');
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["setDoc"])(siteDetailsDocRef, {
        ...
        return {
            success: true,
            message: 'Configuración del sitio guardada con éxito. Los cambios pueden tardar unos momentos en reflejarse completamente.'
        };
    } catch (error) {
        console.error("Error saving site settings to Firestore:", error);
        return {
            success: false,
            message: `Error al guardar la configuración del sitio: ${error.message}`
        };
    }
}
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getSiteDetails, "00e84c300fdf537aa199023c4a6d4f8cd1678840ab", null);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/actions.ts [app-rsc] (ecmascript)"); // Import the new action
;
;
;
;
...
async function generateMetadata() {
    const siteDetails = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSiteDetails"])();
    return {
        title: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d8f48674._.js.map